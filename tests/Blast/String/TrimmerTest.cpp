...
TEST(Blast_String_TrimmerTest, can_be_created_without_arguments)
{
   Trimmer trimmer;
}


TEST(Blast_String_TrimmerTest, trim__returns_the_string_with_leading_and_trailing_whitespace_removed)
{
