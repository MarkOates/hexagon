...
class Hexagon_Shaders_TruchetVineSquiggleTest : public ::testing::Test
{
protected:
   ALLEGRO_DISPLAY *display;

   Hexagon_Shaders_TruchetVineSquiggleTest()
      : display(nullptr)
   {}
...
class Hexagon_Shaders_TruchetVineSquiggleTest_WithEventQueueFixture : public ::testing::Test
{
public:
   ALLEGRO_DISPLAY* display;
...
public:
   Hexagon_Shaders_TruchetVineSquiggleTest_WithEventQueueFixture()
      : display(nullptr)
      , font_bin()
      , timer()
      , event_queue(nullptr)
...
TEST_F(Hexagon_Shaders_TruchetVineSquiggleTest, DISABLED_can_be_created_without_blowing_up)
{
   Hexagon::Shaders::TruchetVineSquiggle flat_color_shader;
   SUCCEED();
}


TEST_F(Hexagon_Shaders_TruchetVineSquiggleTest, DISABLED_activate__before_being_initialized_raises_an_exception)
{
   Hexagon::Shaders::TruchetVineSquiggle flat_color_shader;
   std::string expected_error_message = "TruchetVineSquiggle::activate: error: guard \"initialized\" not met";
   ASSERT_THROW_WITH_MESSAGE(flat_color_shader.activate(), std::runtime_error, expected_error_message);
}


TEST_F(Hexagon_Shaders_TruchetVineSquiggleTest, DISABLED_initialize__works_without_blowing_up)
{
   Hexagon::Shaders::TruchetVineSquiggle flat_color_shader;
...
TEST_F(Hexagon_Shaders_TruchetVineSquiggleTest, DISABLED_activate__works_without_blowing_up)
{
   Hexagon::Shaders::TruchetVineSquiggle flat_color_shader;
   flat_color_shader.initialize();
...
TEST_F(Hexagon_Shaders_TruchetVineSquiggleTest_WithEventQueueFixture, when_active__renders_the_image_with_the_flat_color)
{
   Hexagon::Shaders::TruchetVineSquiggle flat_color_shader;
