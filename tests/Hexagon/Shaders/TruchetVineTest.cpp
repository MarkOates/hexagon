...
class Hexagon_Shaders_TruchetVineTest : public ::testing::Test
{
protected:
   ALLEGRO_DISPLAY *display;

   Hexagon_Shaders_TruchetVineTest()
      : display(nullptr)
   {}
...
class Hexagon_Shaders_TruchetVineTest_WithEventQueueFixture : public ::testing::Test
{
public:
   ALLEGRO_DISPLAY* display;
...
public:
   Hexagon_Shaders_TruchetVineTest_WithEventQueueFixture()
      : display(nullptr)
      , font_bin()
      , timer()
      , event_queue(nullptr)
...
TEST_F(Hexagon_Shaders_TruchetVineTest, DISABLED_can_be_created_without_blowing_up)
{
   Hexagon::Shaders::TruchetVine flat_color_shader;
   SUCCEED();
}


TEST_F(Hexagon_Shaders_TruchetVineTest, DISABLED_activate__before_being_initialized_raises_an_exception)
{
   Hexagon::Shaders::TruchetVine flat_color_shader;
   std::string expected_error_message = "TruchetVine::activate: error: guard \"initialized\" not met";
   ASSERT_THROW_WITH_MESSAGE(flat_color_shader.activate(), std::runtime_error, expected_error_message);
}


TEST_F(Hexagon_Shaders_TruchetVineTest, DISABLED_initialize__works_without_blowing_up)
{
   Hexagon::Shaders::TruchetVine flat_color_shader;
...
TEST_F(Hexagon_Shaders_TruchetVineTest, DISABLED_activate__works_without_blowing_up)
{
   Hexagon::Shaders::TruchetVine flat_color_shader;
   flat_color_shader.initialize();
...
TEST_F(Hexagon_Shaders_TruchetVineTest_WithEventQueueFixture, when_active__renders_the_image_with_the_flat_color)
{
   Hexagon::Shaders::TruchetVine flat_color_shader;
