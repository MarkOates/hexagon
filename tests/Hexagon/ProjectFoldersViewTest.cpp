...
class Hexagon_ProjectFoldersViewTest : public ::testing::Test
{
protected:
   ALLEGRO_DISPLAY *display;
   AllegroFlare::FontBin font_bin;

   Hexagon_ProjectFoldersViewTest()
      : display(nullptr)
      , font_bin()
   {}
...
TEST_F(Hexagon_ProjectFoldersViewTest, can_be_created_without_blowing_up)
{
   Hexagon::ProjectFoldersView project_navigator;
}


TEST_F(Hexagon_ProjectFoldersViewTest, contains_an_empty_list_of_menu_items_by_default)
{
   Hexagon::ProjectFoldersView project_navigator;
...
TEST_F(Hexagon_ProjectFoldersViewTest, set_menu_items__will_set_the_menu_items)
{
   Hexagon::ProjectFoldersView project_navigator;
   project_navigator.set_menu_items(Hexagon::ProjectFoldersView::build_placeholder_menu_items());
