...
TEST(Hexagon_ProjectComponentNavigator_ComponentSearcherTest, component_names__returns_the_expected_response)
{
   std::string project_root_directory = "/Users/markoates/Repos/blast";
   Hexagon::ProjectComponentNavigator::ComponentSearcher list(project_root_directory);
...
TEST(DISABLED_Hexagon_ProjectComponentNavigator_ComponentSearcherTest,
   ...
   // this disabled because the list does not match across different computers
{
   ...
   Hexagon::ProjectComponentNavigator::ComponentSearcher list(project_root_directory, search_text);
...
TEST(Hexagon_ProjectComponentNavigator_ComponentSearcherTest,
   components_sorted_by_most_recent__returns_results_filtered_by_search_string)
{
   std::string project_root_directory = "/Users/markoates/Repos/blast";
   Hexagon::ProjectComponentNavigator::ComponentSearcher searcher(project_root_directory, "ProgramLister");
