...
TEST(Hexagon_ProjectComponentNavigator_EventControllerTest, can_be_created_without_blowing_up)
{
   Hexagon::ProjectComponentNavigator::EventController event_controller;
}

TEST(Hexagon_ProjectComponentNavigator_EventControllerTest, process_local_event__processes_the_events)
{
   ...
   ProjectComponentNavigator stage;
   Hexagon::ProjectComponentNavigator::EventController event_controller(&stage, event_dictionary);
...
TEST(Hexagon_ProjectComponentNavigator_EventControllerTest,
   process_local_event__with_an_event_that_does_not_exist_throws_an_error)
{
   Hexagon::ProjectComponentNavigator::ProjectComponentNavigator stage;
   Hexagon::ProjectComponentNavigator::EventController event_controller(&stage);

   std::string expected_error_message = "ProjectComponentNavigator::EventController::process_local_event: " \
