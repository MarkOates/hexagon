...
void ProjectNavigator::__draw_hexagon_logo_and_wait_for_keypress()
{
   if (!(al_is_system_installed()))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "__draw_hexagon_logo_and_wait_for_keypress" << ": error: " << "guard \"al_is_system_installed()\" not met";
         throw std::runtime_error(error_message.str());
      }
   if (!(al_is_primitives_addon_initialized()))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "__draw_hexagon_logo_and_wait_for_keypress" << ": error: " << "guard \"al_is_primitives_addon_initialized()\" not met";
         throw std::runtime_error(error_message.str());
      }
   if (!(font_bin))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "__draw_hexagon_logo_and_wait_for_keypress" << ": error: " << "guard \"font_bin\" not met";
         throw std::runtime_error(error_message.str());
      }
   if (!(al_get_target_bitmap()))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "__draw_hexagon_logo_and_wait_for_keypress" << ": error: " << "guard \"al_get_target_bitmap()\" not met";
         throw std::runtime_error(error_message.str());
      }
   if (!(get_initialized()))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "__draw_hexagon_logo_and_wait_for_keypress" << ": error: " << "guard \"get_initialized()\" not met";
         throw std::runtime_error(error_message.str());
      }
...
void ProjectNavigator::render_profiler_graph(AllegroFlare::Profiler* profiler, ALLEGRO_FONT* font)
{
   if (!(profiler))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "render_profiler_graph" << ": error: " << "guard \"profiler\" not met";
         throw std::runtime_error(error_message.str());
      }
   if (!(font))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "render_profiler_graph" << ": error: " << "guard \"font\" not met";
         throw std::runtime_error(error_message.str());
      }
...
void ProjectNavigator::append_project_path_to_config_file_and_reload_injected_config()
{
   if (!(config))
      {
         std::stringstream error_message;
         error_message << "ProjectNavigator" << "::" << "append_project_path_to_config_file_and_reload_injected_config" << ": error: " << "guard \"config\" not met";
         throw std::runtime_error(error_message.str());
      }
