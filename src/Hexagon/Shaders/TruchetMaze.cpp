...
void TruchetMaze::activate()
{
   if (!(initialized))
   {
      ...
      error_message << "[Hexagon::Shaders::TruchetMaze::activate]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Shaders::TruchetMaze::activate]: error: guard \"initialized\" not met");
   }
...
void TruchetMaze::deactivate()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::Shaders::TruchetMaze::deactivate]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Shaders::TruchetMaze::deactivate]: error: guard \"initialized\" not met");
   }
