...
void TruchetVineSquiggle::activate()
{
   if (!(initialized))
   {
      ...
      error_message << "[Hexagon::Shaders::TruchetVineSquiggle::activate]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Shaders::TruchetVineSquiggle::activate]: error: guard \"initialized\" not met");
   }
...
void TruchetVineSquiggle::deactivate()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::Shaders::TruchetVineSquiggle::deactivate]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Shaders::TruchetVineSquiggle::deactivate]: error: guard \"initialized\" not met");
   }
