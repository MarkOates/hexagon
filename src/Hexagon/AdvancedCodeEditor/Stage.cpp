...
result.set_mapping(ALLEGRO_KEY_U, KeyboardCommandMapper::CTRL, { "cursor_jump_up_half_page" });
result.set_mapping(ALLEGRO_KEY_D, KeyboardCommandMapper::CTRL, { "cursor_jump_down_half_page" });
result.set_mapping(ALLEGRO_KEY_B, 0, { "cursor_jump_to_previous_word" });
