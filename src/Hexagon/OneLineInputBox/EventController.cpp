...
OneLineInputBox::EventController::EventController(Hexagon::OneLineInputBox::Stage *stage)
...
OneLineInputBox::EventController::~EventController()
{}



bool OneLineInputBox::EventController::clear_last_performed_action_queue_recording()
{
...
bool OneLineInputBox::EventController::start_recording_last_performed_action_queue_recording()
{
...
bool OneLineInputBox::EventController::stop_recording_last_performed_action_queue_recording()
{
   last_performed_action_queue_is_recording = false;
   return true;
}
...
bool OneLineInputBox::EventController::is_last_performed_action_queue_recording()
{
...
bool OneLineInputBox::EventController::play_last_performed_action_queue_recording()
{
...
void OneLineInputBox::EventController::process_local_event(std::string event_name, ActionData action_data1)
{
   if (!stage)
   {
      throw std::runtime_error("[OneLineInputBox::EventController::process_local_event()] error: stage cannot be a nullptr");
   }

   std::cout << "OneLineInputBox::EventController::" << event_name << std::endl;
   ...
   {
      std::cout << "   \033[0;30mOneLineInputBox:: recording "
                << event_name
...
void OneLineInputBox::EventController::process_event(ALLEGRO_EVENT &event)
{
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_0, false, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_START_OF_LINE,
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_I, true,  false, false, false, {
      ::OneLineInputBox::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      //OneLineInputBox::EventController::MOVE_CURSOR_TO_START_OF_LINE,
      //OneLineInputBox::EventController::MOVE_CURSOR_JUMP_TO_NEXT_WORD,
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_FIRST_NON_WHITESPACE_CHARACTER,
      ::OneLineInputBox::EventController::SET_INSERT_MODE,
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_A, true,  false, false, false, {
      ::OneLineInputBox::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_END_OF_LINE,
      ::OneLineInputBox::EventController::SET_INSERT_MODE,
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_A, false,  false, false, false, {
      ::OneLineInputBox::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::MOVE_CURSOR_RIGHT,
      ::OneLineInputBox::EventController::SET_INSERT_MODE,
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_J, false, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_DOWN
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_J, true,  false, false, false, {
      ::OneLineInputBox::EventController::JOIN_LINES
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_K, false, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_UP
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_H, false, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_LEFT
      });
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_H, true, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_TOP_OF_SCREEN
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_M, true, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_MIDDLE_OF_SCREEN
      });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_L, true, false, false, false, {
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_BOTTOM_OF_SCREEN
      });
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, false, false, false, {
      ::OneLineInputBox::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::DELETE_CHARACTER, ::OneLineInputBox::EventController::SET_INSERT_MODE, });
   //edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, true, false, false, {
   //   ::OneLineInputBox::EventController::SAVE_FILE_AND_TOUCH_IF_SYMLINK,
   //   ::OneLineInputBox::EventController::REFRESH_GIT_MODIFIED_LINE_NUMBERS });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_B, false, true, false, false, {
      ::OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_UP_WHOLE_SCREEN,
      ::OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_UP_WHOLE_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_F, false, true, false, false, {
      ::OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_DOWN_WHOLE_SCREEN,
      ::OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_DOWN_WHOLE_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_U, false, true, false, false, {
      ::OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_UP,
      ::OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_UP });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_D, false, true, false, false, {
      ::OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_DOWN,
      ::OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_DOWN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_Y, false, true, false, false, {
      ::OneLineInputBox::EventController::STEP_FIRST_LINE_NUM_UP });
   //edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_E, false, true, false, false, {
   //   OneLineInputBox::EventController::STEP_FIRST_LINE_NUM_DOWN });
   //edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_EQUALS, false, true, false, false, {
   //   OneLineInputBox::EventController::SCALE_STAGE_UP });
   //edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_MINUS, false, true, false, false, {
   //   OneLineInputBox::EventController::SCALE_STAGE_DOWN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_O, false, false, false, false, {
      ::OneLineInputBox::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING,
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_END_OF_LINE,
      ::OneLineInputBox::EventController::SPLIT_LINES,
      ::OneLineInputBox::EventController::MOVE_CURSOR_DOWN,
      ::OneLineInputBox::EventController::MOVE_CURSOR_TO_START_OF_LINE,
      ::OneLineInputBox::EventController::SET_INSERT_MODE,
      });
   ...
   //   OneLineInputBox::EventController::TOGGLE_SHOWING_CODE_MESSAGE_POINTS });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_SLASH, false, false, false, false, {
      ::OneLineInputBox::EventController::REFRESH_REGEX_MESSAGE_POINTS });
   ...
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_ESCAPE, false, false, false, false, {
      ::OneLineInputBox::EventController::SET_EDIT_MODE,
      ::OneLineInputBox::EventController::STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING });
...
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_TOP_OF_SCREEN = "MOVE_CURSOR_TO_TOP_OF_SCREEN";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_MIDDLE_OF_SCREEN = "MOVE_CURSOR_TO_MIDDLE_OF_SCREEN";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_BOTTOM_OF_SCREEN = "MOVE_CURSOR_TO_BOTTOM_OF_SCREEN";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_JUMP_TO_NEXT_WORD = "MOVE_CURSOR_JUMP_TO_NEXT_WORD";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_JUMP_TO_NEXT_BIG_WORD = "MOVE_CURSOR_JUMP_TO_NEXT_BIG_WORD";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_JUMP_TO_PREVIOUS_WORD = "MOVE_CURSOR_JUMP_TO_PREVIOUS_WORD";
std::string const OneLineInputBox::EventController::JUMP_CURSOR_TO_END_OF_NEXT_WORD = "JUMP_CURSOR_TO_END_OF_NEXT_WORD";
std::string const OneLineInputBox::EventController::JUMP_CURSOR_TO_END_OF_NEXT_BIG_WORD =
   "JUMP_CURSOR_TO_END_OF_NEXT_BIG_WORD";
std::string const OneLineInputBox::EventController::JUMP_TO_NEXT_CODE_POINT = "JUMP_TO_NEXT_CODE_POINT";
std::string const OneLineInputBox::EventController::JUMP_TO_PREVIOUS_CODE_POINT = "JUMP_TO_PREVIOUS_CODE_POINT";
std::string const OneLineInputBox::EventController::JUMP_TO_NEXT_OR_NEAREST_CODE_POINT = "JUMP_TO_NEXT_OR_NEAREST_CODE_POINT";
std::string const OneLineInputBox::EventController::DELETE_CHARACTER = "DELETE_CHARACTER";
std::string const OneLineInputBox::EventController::INSERT_STRING = "INSERT_STRING";
std::string const OneLineInputBox::EventController::SET_INSERT_MODE = "SET_INSERT_MODE";
std::string const OneLineInputBox::EventController::SET_EDIT_MODE = "SET_EDIT_MODE";
std::string const OneLineInputBox::EventController::JOIN_LINES = "JOIN_LINES";
std::string const OneLineInputBox::EventController::SPLIT_LINES = "SPLIT_LINES";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_START_OF_LINE = "MOVE_CURSOR_TO_START_OF_LINE";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_END_OF_LINE = "MOVE_CURSOR_TO_END_OF_LINE";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_LAST_CHARACTER_OF_LINE =
   "MOVE_CURSOR_TO_LAST_CHARACTER_OF_LINE";
std::string const OneLineInputBox::EventController::MOVE_CURSOR_TO_FIRST_NON_WHITESPACE_CHARACTER =
   "MOVE_CURSOR_TO_FIRST_NON_WHITESPACE_CHARACTER";
std::string const OneLineInputBox::EventController::SAVE_FILE_AND_TOUCH_IF_SYMLINK = "SAVE_FILE_AND_TOUCH_IF_SYMLINK";
//std::string const OneLineInputBox::EventController::MOVE_STAGE_UP = "MOVE_STAGE_UP";
//std::string const OneLineInputBox::EventController::MOVE_STAGE_DOWN = "MOVE_STAGE_DOWN";
std::string const OneLineInputBox::EventController::DELETE_LINE = "DELETE_LINE";
std::string const OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_UP = "JUMP_FIRST_LINE_NUM_UP";
std::string const OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_DOWN = "JUMP_FIRST_LINE_NUM_DOWN";
std::string const OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_UP_WHOLE_SCREEN = "JUMP_FIRST_LINE_NUM_UP_WHOLE_SCREEN";
std::string const OneLineInputBox::EventController::JUMP_FIRST_LINE_NUM_DOWN_WHOLE_SCREEN = "JUMP_FIRST_LINE_NUM_DOWN_WHOLE_SCREEN";
std::string const OneLineInputBox::EventController::STEP_FIRST_LINE_NUM_UP = "STEP_FIRST_LINE_NUM_UP";
std::string const OneLineInputBox::EventController::STEP_FIRST_LINE_NUM_DOWN = "STEP_FIRST_LINE_NUM_DOWN";
std::string const OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_UP = "OFFSET_CURSOR_POSITION_Y_UP";
std::string const OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_DOWN = "OFFSET_CURSOR_POSITION_Y_DOWN";
std::string const OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_UP_WHOLE_SCREEN = "OFFSET_CURSOR_POSITION_Y_UP_WHOLE_SCREEN";
std::string const OneLineInputBox::EventController::OFFSET_CURSOR_POSITION_Y_DOWN_WHOLE_SCREEN = "OFFSET_CURSOR_POSITION_Y_DOWN_WHOLE_SCREEN";
//std::string const OneLineInputBox::EventController::SCALE_STAGE_UP = "SCALE_STAGE_UP";
//std::string const OneLineInputBox::EventController::SCALE_STAGE_DOWN = "SCALE_STAGE_DOWN";
std::string const OneLineInputBox::EventController::REFRESH_GIT_MODIFIED_LINE_NUMBERS = "REFRESH_GIT_MODIFIED_LINE_NUMBERS";
//std::string const OneLineInputBox::EventController::TOGGLE_SHOWING_CODE_MESSAGE_POINTS = "TOGGLE_SHOWING_CODE_MESSAGE_POINTS";
std::string const OneLineInputBox::EventController::ENABLE_DRAWING_INFO_OVERLAY = "ENABLE_DRAWING_INFO_OVERLAY";
std::string const OneLineInputBox::EventController::DISABLE_DRAWING_INFO_OVERLAY = "DISABLE_DRAWING_INFO_OVERLAY";
std::string const OneLineInputBox::EventController::REFRESH_REGEX_MESSAGE_POINTS = "REFRESH_REGEX_MESSAGE_POINTS";
std::string const OneLineInputBox::EventController::OFFSET_FIRST_LINE_TO_VERTICALLY_CENTER_CURSOR = "OFFSET_FIRST_LINE_TO_VERTICALLY_CENTER_CURSOR";
std::string const OneLineInputBox::EventController::CREATE_VISUAL_SELECTION_AT_CURRENT_CURSOR_LOCATION = "CREATE_VISUAL_SELECTION_AT_CURRENT_CURSOR_LOCATION";
std::string const OneLineInputBox::EventController::DESTROY_CURRENT_VISUAL_SELECTION = "DESTROY_CURRENT_VISUAL_SELECTION";
std::string const OneLineInputBox::EventController::TOGGLE_CURRENTLY_GRABBING_VISUAL_SELECTION = "TOGGLE_CURRENTLY_GRABBING_VISUAL_SELECTION";
std::string const OneLineInputBox::EventController::YANK_SELECTED_TEXT_TO_CLIPBOARD = "YANK_SELECTED_TEXT_TO_CLIPBOARD";
std::string const OneLineInputBox::EventController::PASTE_SELECTED_TEXT_FROM_CLIPBOARD = "PASTE_SELECTED_TEXT_FROM_CLIPBOARD";
std::string const OneLineInputBox::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING = "CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING";
std::string const OneLineInputBox::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING = "START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING";
std::string const OneLineInputBox::EventController::STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING = "STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING";
std::string const OneLineInputBox::EventController::PLAY_LAST_PERFORMED_ACTION_QUEUE_RECORDING = "PLAY_LAST_PERFORMED_ACTION_QUEUE_RECORDING";
std::string const OneLineInputBox::EventController::INSERT_THREE_SPACES_AT_START_OF_LINE =
