...
void EventController::process_local_event(std::string event_name, ActionData action_data)
{
   if (!(component))
   {
      ...
      error_message << "[Hexagon::AdvancedComponentNavigator::EventController::process_local_event]: error: guard \"component\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::AdvancedComponentNavigator::EventController::process_local_event]: error: guard \"component\" not met");
   }
