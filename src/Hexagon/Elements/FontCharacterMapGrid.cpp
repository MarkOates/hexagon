...
ALLEGRO_BITMAP* FontCharacterMapGrid::get_created_character_map_bitmap()
{
   if (!(initialized))
   {
      ...
      error_message << "[Hexagon::Elements::FontCharacterMapGrid::get_created_character_map_bitmap]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Elements::FontCharacterMapGrid::get_created_character_map_bitmap]: error: guard \"initialized\" not met");
   }
...
bool FontCharacterMapGrid::initialize()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::Elements::FontCharacterMapGrid::initialize]: error: guard \"al_is_system_installed()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Elements::FontCharacterMapGrid::initialize]: error: guard \"al_is_system_installed()\" not met");
   }
   if (!(font))
   {
      std::stringstream error_message;
      error_message << "[Hexagon::Elements::FontCharacterMapGrid::initialize]: error: guard \"font\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Elements::FontCharacterMapGrid::initialize]: error: guard \"font\" not met");
   }
   if (!((!initialized)))
   {
      std::stringstream error_message;
      error_message << "[Hexagon::Elements::FontCharacterMapGrid::initialize]: error: guard \"(!initialized)\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::Elements::FontCharacterMapGrid::initialize]: error: guard \"(!initialized)\" not met");
   }
