...
//int character_width = al_get_text_width(font, "W"); // 'W' character as an estimate for reasonable large width //int character_height = al_get_font_line_height(font);
//ALLEGRO_BITMAP *result = al_create_bitmap(800, 600); //for (int y=0; y<=10; y++) //{ //for (int x=0; x<=10; x++) //{ //al_draw_text(font, //} //} return nullptr;
}
} // namespace Elements
} // namespace Hexagon
