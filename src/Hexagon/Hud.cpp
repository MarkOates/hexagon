...
void Hud::draw_build_sequence_meter()
{
   ...
   std::vector<std::tuple<std::string, std::string, std::string, std::string>> build_stages = {
     { "started", "SGNL", "not_started", "no_file.txt" },
     ...
     { "delete_focused_component_test_object_file_and_test_executable", "XTOB", "not_started", "no_file.txt" },
     { "build_focused_component_test_object_file_and_test_executable", "BLDT", "not_started", "component_test_object_build.txt" },
     { "run_test_for_focused_component", "TEST", "not_started", "component_test_run.txt" },
     { "make_all_programs", "PROG", "not_started", "no_file.txt" },
     { "make_documentation", "DOCS", "not_started", "no_file.txt" },
     { "signal_component_built_and_integrated", "SIGF", "not_started", "no_file.txt" },
     { "completed", "PASS", "not_started", "no_file.txt" },
   };
