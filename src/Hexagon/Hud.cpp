...
void Hud::draw_build_sequence_meter()
{
   ...
   std::vector<std::tuple<std::string, std::string, std::string>> build_stages = {
     ...
     { "generating_sources_files_from_quintessence", "PRSE", "not_started" },
     { "building_component_object_files", "BUILD", "not_started" },
     { "delete_focused_component_test_object_file_and_test_executable", "XTOB", "not_started" },
     { "build_focused_component_test_object_file_and_test_executable", "BLDT", "not_started" },
     { "run_test_for_focused_component", "TEST", "not_started" },
