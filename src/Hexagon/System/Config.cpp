...
void Config::initialize()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::initialize]: error: guard \"al_is_system_installed()\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::initialize]: error: guard \"al_is_system_installed()\" not met");
   }
...
void Config::reload()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::reload]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::reload]: error: guard \"initialized\" not met");
   }
...
int Config::get_initial_baseline_camera_stepback()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::get_initial_baseline_camera_stepback]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::get_initial_baseline_camera_stepback]: error: guard \"initialized\" not met");
   }
   validate_initialized(__FUNCTION__);
...
bool Config::is_dark_mode()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::is_dark_mode]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::is_dark_mode]: error: guard \"initialized\" not met");
   }
...
std::string Config::get_objective()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::get_objective]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::get_objective]: error: guard \"initialized\" not met");
   }
...
std::string Config::get_current_project_domain()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::get_current_project_domain]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::get_current_project_domain]: error: guard \"initialized\" not met");
   }
...
bool Config::is_fullscreen()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::is_fullscreen]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::is_fullscreen]: error: guard \"initialized\" not met");
   }
...
bool Config::get_hud_show_focus_timer_bar()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::System::Config::get_hud_show_focus_timer_bar]: error: guard \"initialized\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::System::Config::get_hud_show_focus_timer_bar]: error: guard \"initialized\" not met");
   }
