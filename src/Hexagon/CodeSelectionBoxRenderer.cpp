...
void CodeSelectionBoxRenderer::render_full_line_selection()
{
   if (!(code_range))
   {
      ...
      error_message << "[Hexagon::CodeSelectionBoxRenderer::render_full_line_selection]: error: guard \"code_range\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::CodeSelectionBoxRenderer::render_full_line_selection]: error: guard \"code_range\" not met");
   }
...
void CodeSelectionBoxRenderer::render()
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::CodeSelectionBoxRenderer::render]: error: guard \"code_range\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::CodeSelectionBoxRenderer::render]: error: guard \"code_range\" not met");
   }
...
int CodeSelectionBoxRenderer::get_line_length(int line_num)
{
   ...
   {
      std::stringstream error_message;
      error_message << "[Hexagon::CodeSelectionBoxRenderer::get_line_length]: error: guard \"lines\" not met.";
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("[Hexagon::CodeSelectionBoxRenderer::get_line_length]: error: guard \"lines\" not met");
   }
