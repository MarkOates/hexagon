...
{
   if (!stage) throw std::runtime_error("[CodeEditor::EventController::process_local_event()] error: stage cannot be a nullptr");
...
void CodeEditor::EventController::process_event(ALLEGRO_EVENT &event)
{
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_K, false, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_UP });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_H, false, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_LEFT });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_L, false, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_RIGHT });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_H, true, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_TO_TOP_OF_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_M, true, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_TO_MIDDLE_OF_SCREEN });
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_X, false, false, false, false, { CodeEditor::EventController::DELETE_CHARACTER });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_I, false, false, false, false, { CodeEditor::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, CodeEditor::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, CodeEditor::EventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_0, false, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_TO_START_OF_LINE });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, false, false, false, { CodeEditor::EventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, CodeEditor::EventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, CodeEditor::EventController::DELETE_CHARACTER, CodeEditor::EventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, true, false, false, { CodeEditor::EventController::SAVE_FILE });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_B, false, true, false, false, { CodeEditor::EventController::JUMP_FIRST_LINE_NUM_UP_WHOLE_SCREEN, CodeEditor::EventController::OFFSET_CURSOR_POSITION_Y_UP_WHOLE_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_F, false, true, false, false, { CodeEditor::EventController::JUMP_FIRST_LINE_NUM_DOWN_WHOLE_SCREEN, CodeEditor::EventController::OFFSET_CURSOR_POSITION_Y_DOWN_WHOLE_SCREEN });
   ...
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_ESCAPE, false, false, false, false, { CodeEditor::EventController::SET_EDIT_MODE, CodeEditor::EventController::STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_OPENBRACE, false, true, false, false, { CodeEditor::EventController::SET_EDIT_MODE, CodeEditor::EventController::STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_BACKSPACE, false, false, false, false, { CodeEditor::EventController::MOVE_CURSOR_LEFT, CodeEditor::EventController::DELETE_CHARACTER });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_ENTER, false, false, false, false, { CodeEditor::EventController::SPLIT_LINES, CodeEditor::EventController::MOVE_CURSOR_DOWN, CodeEditor::EventController::MOVE_CURSOR_TO_START_OF_LINE });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, true, false, false, { CodeEditor::EventController::SAVE_FILE });
