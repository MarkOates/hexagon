...
void StageEventController::process_event(ALLEGRO_EVENT &event)
{
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_0, false, false, false, false, { StageEventController::MOVE_CURSOR_TO_START_OF_LINE });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_I, true,  false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::MOVE_CURSOR_TO_START_OF_LINE, StageEventController::MOVE_CURSOR_JUMP_TO_NEXT_WORD, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_A, true,  false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::MOVE_CURSOR_TO_END_OF_LINE, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_A, false,  false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::MOVE_CURSOR_RIGHT, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_J, false, false, false, false, { StageEventController::MOVE_CURSOR_DOWN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_J, true,  false, false, false, { StageEventController::JOIN_LINES });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_K, false, false, false, false, { StageEventController::MOVE_CURSOR_UP });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_H, false, false, false, false, { StageEventController::MOVE_CURSOR_LEFT });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_L, false, false, false, false, { StageEventController::MOVE_CURSOR_RIGHT });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_H, true, false, false, false, { StageEventController::MOVE_CURSOR_TO_TOP_OF_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_M, true, false, false, false, { StageEventController::MOVE_CURSOR_TO_MIDDLE_OF_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_L, true, false, false, false, { StageEventController::MOVE_CURSOR_TO_BOTTOM_OF_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_W, false, false, false, false, { StageEventController::MOVE_CURSOR_JUMP_TO_NEXT_WORD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_W, true, false, false, false, { StageEventController::MOVE_CURSOR_JUMP_TO_NEXT_BIG_WORD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_E, false, false, false, false, { StageEventController::JUMP_CURSOR_TO_END_OF_NEXT_WORD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_E, true, false, false, false, { StageEventController::JUMP_CURSOR_TO_END_OF_NEXT_BIG_WORD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_B, false, false, false, false, { StageEventController::MOVE_CURSOR_JUMP_TO_PREVIOUS_WORD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_N, false, false, false, false, { StageEventController::JUMP_TO_NEXT_CODE_POINT, StageEventController::OFFSET_FIRST_LINE_TO_VERTICALLY_CENTER_CURSOR });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_N, true, false, false, false, { StageEventController::JUMP_TO_PREVIOUS_CODE_POINT, StageEventController::OFFSET_FIRST_LINE_TO_VERTICALLY_CENTER_CURSOR });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_X, false, false, false, false, { StageEventController::DELETE_CHARACTER });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_I, false, false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_0, false, false, false, false, { StageEventController::MOVE_CURSOR_TO_START_OF_LINE });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::DELETE_CHARACTER, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, true, false, false, { StageEventController::SAVE_FILE });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_B, false, true, false, false, { StageEventController::JUMP_FIRST_LINE_NUM_UP_WHOLE_SCREEN, StageEventController::OFFSET_CURSOR_POSITION_Y_UP_WHOLE_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_F, false, true, false, false, { StageEventController::JUMP_FIRST_LINE_NUM_DOWN_WHOLE_SCREEN, StageEventController::OFFSET_CURSOR_POSITION_Y_DOWN_WHOLE_SCREEN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_U, false, true, false, false, { StageEventController::JUMP_FIRST_LINE_NUM_UP, StageEventController::OFFSET_CURSOR_POSITION_Y_UP });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_D, false, true, false, false, { StageEventController::JUMP_FIRST_LINE_NUM_DOWN, StageEventController::OFFSET_CURSOR_POSITION_Y_DOWN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_Y, false, true, false, false, { StageEventController::STEP_FIRST_LINE_NUM_UP });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_E, false, true, false, false, { StageEventController::STEP_FIRST_LINE_NUM_DOWN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_EQUALS, false, true, false, false, { StageEventController::SCALE_STAGE_UP });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_MINUS, false, true, false, false, { StageEventController::SCALE_STAGE_DOWN });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_O, false, false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::MOVE_CURSOR_TO_END_OF_LINE, StageEventController::SPLIT_LINES, StageEventController::MOVE_CURSOR_DOWN, StageEventController::MOVE_CURSOR_TO_START_OF_LINE, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_O, true, false, false, false, { StageEventController::CLEAR_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::START_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING, StageEventController::MOVE_CURSOR_UP, StageEventController::MOVE_CURSOR_TO_END_OF_LINE, StageEventController::SPLIT_LINES, StageEventController::MOVE_CURSOR_DOWN, StageEventController::MOVE_CURSOR_TO_START_OF_LINE, StageEventController::SET_INSERT_MODE, });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_G, false, false, true, false, { StageEventController::SAVE_FILE, StageEventController::REFRESH_GIT_MODIFIED_LINE_NUMBERS });
   ...
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_SLASH, false, false, false, false, { StageEventController::REFRESH_REGEX_MESSAGE_POINTS });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_Z, false, false, false, false, { StageEventController::OFFSET_FIRST_LINE_TO_VERTICALLY_CENTER_CURSOR });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_V, false, false, false, false, { StageEventController::TOGGLE_CURRENTLY_GRABBING_VISUAL_SELECTION });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_Y, false, false, false, false, { StageEventController::YANK_SELECTED_TEXT_TO_CLIPBOARD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_P, true, false, false, false, { StageEventController::PASTE_SELECTED_TEXT_FROM_CLIPBOARD });
   edit_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_FULLSTOP, false, false, false, false, { StageEventController::PLAY_LAST_PERFORMED_ACTION_QUEUE_RECORDING });


   //std::map<std::tuple<int, bool, bool, bool>, std::vector<std::string>> mapping;
   //bool set_mapping(int al_keycode, bool shift, bool ctrl, bool alt, std::vector<std::string> comand_identifier);
   KeyboardCommandMapper insert_mode__keyboard_command_mapper;
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_ESCAPE, false, false, false, false, { StageEventController::SET_EDIT_MODE, StageEventController::STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_OPENBRACE, false, true, false, false, { StageEventController::SET_EDIT_MODE, StageEventController::STOP_RECORDING_LAST_PERFORMED_ACTION_QUEUE_RECORDING });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_BACKSPACE, false, false, false, false, { StageEventController::MOVE_CURSOR_LEFT, StageEventController::DELETE_CHARACTER });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_ENTER, false, false, false, false, { StageEventController::SPLIT_LINES, StageEventController::MOVE_CURSOR_DOWN, StageEventController::MOVE_CURSOR_TO_START_OF_LINE });
   insert_mode__keyboard_command_mapper.set_mapping(ALLEGRO_KEY_S, false, true, false, false, { StageEventController::SAVE_FILE });
