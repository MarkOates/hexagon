...
void DrawingBox::initialize()
{
   if (!((!get_initialized())))
   {
      ...
      throw std::runtime_error("DrawingBox::initialize: error: guard \"(!get_initialized())\" not met");
   }
   if (!(al_is_system_installed()))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::initialize: error: guard \"al_is_system_installed()\" not met");
   }
...
void DrawingBox::render()
{
   if (!(get_initialized()))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::render: error: guard \"get_initialized()\" not met");
   }
...
ALLEGRO_FONT* DrawingBox::obtain_eurostile_title_font()
{
   if (!(font_bin))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::obtain_eurostile_title_font: error: guard \"font_bin\" not met");
   }
...
ALLEGRO_FONT* DrawingBox::obtain_info_font()
{
   if (!(font_bin))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::obtain_info_font: error: guard \"font_bin\" not met");
   }
...
void DrawingBox::draw_crosshair()
{
   if (!(al_is_primitives_addon_initialized()))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::draw_crosshair: error: guard \"al_is_primitives_addon_initialized()\" not met");
   }
   float x = pointer_x;
   float y = pointer_y;
   float size = 16;
...
bool DrawingBox::save_surface_to_desktop_with_autogenerated_name()
{
   if (!(get_initialized()))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::save_surface_to_desktop_with_autogenerated_name: error: guard \"get_initialized()\" not met");
   }
   if (!(al_is_image_addon_initialized()))
   {
      ...
      std::cerr << "\033[1;31m" << error_message.str() << " An exception will be thrown to halt the program.\033[0m" << std::endl;
      throw std::runtime_error("DrawingBox::save_surface_to_desktop_with_autogenerated_name: error: guard \"al_is_image_addon_initialized()\" not met");
   }
