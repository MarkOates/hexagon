...
al_draw_textf(font, text_color, 20, 20, ALLEGRO_ALIGN_LEFT, "Searches: 0", packet->get_searches_count());
al_draw_textf(font, text_color, 20, 20 + line_height, ALLEGRO_ALIGN_LEFT, "Saves: 0", packet->get_saves_count());
return;
