...
namespace Hexagon
{
   ...
   private:
      ...
      bool show_domain;
      std::string held_component_text;
      bool show_held_component;
   ...
   public:
      ...
      void set_held_component_text(std::string held_component_text);
      void set_show_held_component(bool show_held_component);
      std::vector<std::string> get_notifications() const;
      std::vector<std::string> get_notifications2() const;
      std::string get_title_text() const;
      bool get_show_disabled_screen() const;
      bool get_show_powerbar() const;
      bool get_show_profiler() const;
      bool get_show_save_count() const;
      int get_save_count() const;
      bool get_show_packets() const;
      std::vector<Hexagon::Packet> get_packets() const;
      bool get_show_search_count() const;
      int get_search_count() const;
      bool get_show_focus_timer_bar() const;
      bool get_show_build_sequence_meter() const;
      bool get_show_notifications() const;
      float get_left_column_x() const;
      float get_surface_projection_width() const;
      float get_surface_projection_height() const;
      bool get_current_component_is_symlinked_thus_has_different_title_color() const;
      bool get_show_caps_lock_notification_light() const;
      ALLEGRO_COLOR get_base_text_color() const;
      float get_base_text_opacity() const;
      std::string get_objective_text() const;
      bool get_show_objective() const;
      std::string get_domain_text() const;
      bool get_show_domain() const;
      std::string get_held_component_text() const;
      bool get_show_held_component() const;
      ...
      ALLEGRO_FONT* obtain_held_component_font();
