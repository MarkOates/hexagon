...
namespace Hexagon
{
   namespace AdvancedCodeEditor
   {
      ...
      public:
         Renderer(Hexagon::Elements::TextMesh* text_mesh=nullptr, ALLEGRO_BITMAP* surface_render=nullptr, Hexagon::AdvancedCodeEditor::Cursor* cursor=nullptr, float width=1, float height=1, bool cursor_is_bar=false, float text_mesh_y_offset=0.0f, int first_row_offset=0, bool draw_line_numbers=false, ALLEGRO_FONT* font=nullptr);
         ~Renderer();
