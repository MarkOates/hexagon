...
namespace Hexagon
{
   namespace Elements
   {
      ...
      public:
         ...
         float get_box_opacity() const;
         float get_cell_padding() const;
         ALLEGRO_COLOR get_box_fill_color() const;
         ALLEGRO_COLOR get_header_bar_color() const;
         ALLEGRO_COLOR get_bottom_line_color() const;
         ALLEGRO_COLOR get_outer_line_color() const;
         ALLEGRO_COLOR get_header_baseline_color() const;
         ALLEGRO_COLOR get_top_left_little_bar_color() const;
         ALLEGRO_COLOR get_corner_squares_color() const;
         float get_header_bar_height() const;
         float get_header_baseline_thickness() const;
         float get_header_bar_opacity() const;
         float get_header_baseline_opacity() const;
         float get_top_left_little_bar_width() const;
         float get_outer_line_thickness() const;
         float get_outer_line_opacity() const;
         float get_bottom_line_thickness() const;
         float get_bottom_line_opacity() const;
         bool get_corner_squares_resize_from_center() const;
         float get_corner_squares_width() const;
         float get_corner_squares_height() const;
         float get_corner_squares_opacity() const;
         bool get_corner_squares_are_circles() const;
