...
namespace Hexagon
{
   namespace System
   {
      namespace Action
      {
         class AttemptToCreateCodeEditorStageFromFilename : public ::Action
         {
         private:
            std::string filename;
