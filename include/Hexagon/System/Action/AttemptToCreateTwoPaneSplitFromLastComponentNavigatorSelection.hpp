...
namespace Hexagon
{
   namespace System
   {
      namespace Action
      {
         ...
         public:
            AttemptToCreateTwoPaneSplitFromLastComponentNavigatorSelection(std::string last_component_navigator_selection="", int display_default_width=2430, int display_default_height=1350, std::vector<StageInterface *>& stages=get_dummy_stages_ref());
