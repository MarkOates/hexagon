...
namespace Hexagon
{
   namespace Testing
   {
      ...
      private:
         ...
         bool warnings_errors_and_notes_parsed;
      ...
      public:
         ...
         std::vector<Hexagon::Testing::ClangBuildOutputResult> get_warnings_errors_and_notes() const;
         ...
         void parse_warnings_errors_and_notes();
